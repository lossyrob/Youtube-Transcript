# AIE CODE 2025 - Summary Index

This index tracks all summarized talks for cross-referencing during the phased summarization process.

## How to Use
- Reference this index when writing the "Cross-Talk Connections" section
- Update this index after completing each talk summary
...
|---|---------|---------|-----------------|
| 00 | Opening Performance + Alex Lieberman | Morning Brew/10x | AI-generated poetry frames coding as human-AI co-creation; conference kickoff |
| 02 | Katelyn Lesse | Anthropic | Maximize agent performance via context management, MCP+skills, and letting Claude run code autonomously |
...
After summarizing talk #X:
1. Replace `[Pending]` with a ≤15 word thesis
2. Save this file
3. The next summarization phase will read this updated index
